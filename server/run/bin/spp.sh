...
spp_ctrl_confname='../conf/spp_ctrl.xml'
spp_proxy_confname='../conf/spp_proxy.xml'
spp_worker_confname='../conf/spp_worker1.xml'

export LD_LIBRARY_PATH=../../extlib/spp3.0.1/lib/:$LD_LIBRARY_PATH
